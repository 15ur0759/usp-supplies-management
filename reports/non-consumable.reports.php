...
function getItems($conn){
    return $conn->query("SELECT * FROM items INNER JOIN categories ON items.item_category = categories.cat_id INNER JOIN measurement ON items.measurement = measurement.id INNER JOIN suppliers ON items.supplier = suppliers.supplier_id WHERE items.item_type='2'");
}
...
<div class="release-report-container shadow">
      ...
      <div class="release-header-text text-center mt-5">
       All Non-Consumable Items Report Summary
      </div>
