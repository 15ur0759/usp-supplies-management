...
$quantities = releaseDetails($conn,$requestId);

$units = releaseDetails($conn,$requestId);
$items = releaseDetails($conn,$requestId);
$dates = releaseDetails($conn,$requestId);
          ...
          <div class="release-main-box ">
             <div class="main-release-table">
                <div class=" quantity">
                    ...
                    ?>
                     <div class="displays"><?=$quantity['item_quantity'];?></div>
                    <?php }?>
