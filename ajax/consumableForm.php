...
<?php
 ...
 $categories = consumableCategories($conn);
...
<div class="main-form-request mt-5">
   <div class="main-form-left  me-4">
     <div class="form-group form-group-select">
        ...
        <input type="hidden" name="" id="currentType" value="1">
       ...
       <div class="main-form-left-input position-relative">
          <label>Item</label>
...
<script>
    ...
    var listLoader = () =>{
        $('#listDisplay').load('../../ajax/list.table.php')
    }
    ...
    var setSelected = (id,description,maximum)=>{
        ...
        document.querySelector('#searchInput').value= description.innerText
        hideResult()
