    ...
    <tr>
        ...
        <td class="text-center"><div class="form-check form-switch">
            ...
            <div class="table-controls text-center d-flex justify-content-center">
                <div onclick="updateCategory('<?=$row['cat_id']?>','<?=$row['itemtype']?>','<?=$row['categ_description']?>','<?=$row['isAvailable']?>','1')" data-toggle="modal" data-target="#editCategory" class="table-control table-control-edit">
                    <i class="fas fa-edit"></i>
                </div>
                <div onclick="deleteCategory(<?=$row['cat_id'];?>,1)" class="table-control table-control-delete">
