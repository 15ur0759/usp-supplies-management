        ...
        <div class="side-nav">
            <div class="side-nav-header">
                ...
                <div class="side-nav-links">
                    <ul>
                        <li><a  class=""  href="./instructorNewRequest.php">
                            <span>
                        ...
                        <li><a  class="nav-links-active"  href="./instructor.request.php">
                            <span>
                        ...
                        <li><a  class=""  href="./instructor.release.php">
                            <span>
                ...
                <div class="side-nav-links mt-3 border-top">
                    <ul>
                        <li><a href="./instructor.credentials.php"><span><i
                ...
                <div class=" categories-main-right">
                          <div class="main-category-header border-bottom">
                            <div class="main-category-options d-flex align-items-center">
                                <!-- <div onclick="loadRequestForm(this)"  class="main-category-type main-category-active"><i class="fas fa-plus me-2"></i>New Request</div> -->
                                <div   class="main-category-type main-category-active"><i class="fas fa-chart-line me-2"></i>All Requests</div>
                                <!-- <div onclick="loadRelease(this)"  class="main-category-type "><i class="fas fa-check-double me-2"></i>For Release</div>
