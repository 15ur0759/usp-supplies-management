...
<body>
      ...
      <?php include('../../modals/changeCedStatus.modal.php')?>
        ...
        <div class="side-nav">
            <div class="side-nav-header">
                ...
                <div class="side-nav-links">
                    <ul>
                        <li><a  class="nav-links-active"  href="./ced.request.php">
                            <span>
 ...
 <script>
     ...
     const approveRequest= (id) =>{
      ...
      const loadAll = ()=>{
         $('#requestDisplay').load('../../ajax/ced.request.table.php?type=<?=$showPending?>');
    }
