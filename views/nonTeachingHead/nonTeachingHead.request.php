...
<head>
    ...
    <title>Department Head|| Credentials</title>
</head>

<body>
   
      <?php include('../../modals/changeDeptHeadStatus.modal.php')?>
            ...
            <div class="side-nav-header">
                ...
                <div class="side-nav-header-text border-bottom">
                 ...
                 <div class="side-nav-links">
                    <ul>
                        <li><a class="nav-links-active"  href="./nonTeachingHead.request.php">
                            <span>
                        ...
                        <li><a class=""  href="./nonTeachingHead.personal.request.php">
                            <span>
 ...
 <script>
      ...
      const loadAll = ()=>{
         $('#requestDisplay').load('../../ajax/nonTeachingHead.request.table.php?type=<?=$showPending?>');
    }
