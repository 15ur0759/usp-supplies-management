...
<head>
    ...
    <title>DepartmentHead || Credentials</title>
</head>
        ...
        <div class="side-nav">
            <div class="side-nav-header">
                ...
                <div class="side-nav-links mt-3 border-top">
                    <ul>
                        <li><a  class="nav-links-active" href="./nonTeachingHead.credentials.php" ><span><i
        ...
        <div class="main bg-light">
            ...
            <div class="main-top my-shadow">
                <div class="main-bottom-title"><i
                                        class="fas fa-user-cog me-3"></i>Credentials</div>
