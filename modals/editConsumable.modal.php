...
?>
<!-- Modal -->
<div class="modal fade" id="editConsumable" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      ...
      <form id="editConsumableForm" action="" method="Post">
          <input id="editDateModified" type="hidden" name="dateModified" >
          <div class="modal-body">
            <div class="form-group">
                <label>Item Code</label>
               <input readonly id="editItemCode" required name="editItemCode" type="text" class="form-control">
            </div>
            <div class="form-group">
