...
<!-- Modal -->
<div class="modal fade" id="changeDeanStatus" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
        ...
        <input type="hidden" name="currentRequest" id="currentRequest">
          <div class="modal-body">
            <div class="form-group">
                <textarea required   class="form-control" placeholder="Remarks" name="deanRemarks" id="" cols="30" rows="10"></textarea>
            </div>
          </div>
