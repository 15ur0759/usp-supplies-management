...
// from supplies category controller
   ...
   $categories = getConsumableCategories($conn);
   $measurements = getMeasurements($conn);
   $suppliers = getAllSuppliers($conn);
  
?>
<!-- Modal -->
<div class="modal fade" id="addConsumable" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLongTitle">Add Consumable Item</h5>
      ...
      <form action="" method="Post">
          ...
          <div class="modal-body">
            <div class="form-group">
               ...
               <input readonly value="<?=time().'-SUP-UR'?>" required name="itemCode" type="text" class="form-control">
            </div>
            <div class="form-group">
